        ...
        <div className="col-12 col-md-8 col-lg-6">
          ...
          <form onSubmit={handleSubmit} className="profile-management__form">
            ...
            <div className="profile-management__form-group mb-3">
              <label htmlFor="name" className="profile-management__label">Name</label>
              <input
                type="text"
                name="name"
                value={userData.name || ''}
            ...
            {/* Email Input */}
            <div className="profile-management__form-group mb-3">
              <label htmlFor="email" className="profile-management__label">Email</label>
              <input
                type="email"
                name="email"
            ...
            {/* Bio Input */}
            <div className="profile-management__form-group mb-3">
              <label htmlFor="bio" className="profile-management__label">Bio</label>
              <textarea
                name="bio"
                value={userData.bio || ''}
                onChange={onChange}
            ...
            {/* Interest Input */}
            <div className="profile-management__form-group mb-3">
              <label htmlFor="interest" className="profile-management__label">Interest</label>
              <input
                type="text"
                name="interest"
            ...
            <div className="profile-management__form-group mb-3">
              <label htmlFor="profilePicture" className="profile-management__label">Profile Image</label>
              <input
                type="file"
                name="profilePicture"
