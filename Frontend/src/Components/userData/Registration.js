                        ...
                        <div className="row">
                            ...
                            <div className="col-12 col-md-6">
                                <div className="p-3 p-md-4 p-xl-5">
                                    <div className="mb-5">
                                        <p className={`text-${mode === 'dark' ? 'light' : 'dark'} mb-2`} style={{ fontSize: '1.2rem' }}>
                                    ...
                                    <div className="row gy-3">
                                        <div className="col-12">
                                            <label htmlFor="name" className={`form-label text-${mode === 'dark' ? 'light' : 'dark'}`}>
                                        ...
                                        <div className="col-12">
                                            <label htmlFor="email" className={`form-label text-${mode === 'dark' ? 'light' : 'dark'}`}>
                                        ...
                                        <div className="col-12">
                                            <label htmlFor="interest" className={`form-label text-${mode === 'dark' ? 'light' : 'dark'}`}>
                                        ...
                                        <div className="col-12">
                                            <label htmlFor="password" className={`form-label text-${mode === 'dark' ? 'light' : 'dark'}`}>
                                                Password
                                            </label>
                                            <div className="input-group">
                                                <input
                                        ...
                                        <div className="col-12">
                                            <label htmlFor="cpassword" className={`form-label text-${mode === 'dark' ? 'light' : 'dark'}`}>
                                                Confirm Password
                                            </label>
                                            <div className="input-group">
                                                <input
                                        ...
                                        <div className="col-12">
                                            <label htmlFor="image" className={`form-label text-${mode === 'dark' ? 'light' : 'dark'}`}>
                                                Profile Picture
                                            </label>
                                            <input
                                                type="file"
                                    ...
                                    <div className="mt-4">
                                        <button type="submit" varient="primary" className="btn btn-dark w-100">Register</button>
                                    </div>
                                </div>
                            </div>
                        </div>
