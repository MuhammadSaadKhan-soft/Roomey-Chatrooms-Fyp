...
const Sidebar = ({ toggleSidebar, themes, showAlert }) => {
  ...
  return (
    <div
    className={`offcanvas offcanvas-start ${isOpen ? "show" : ""} ${themes ? "dark-mode" : "light-mode"}`}
...
>
      ...
      <div className={`offcanvas-body px-0 ${themes ? "dark-mode" : "light-mode"}`} >
        <ul className={`list-group list-group-flush ${themes ? "dark-mode" : "light-mode"}`}>
          <li className={`list-group-item ${themes ? "dark-mode" : "light-mode"}`}>
            <div className="mb-3">
              <input
                type="text"
                className={`form-control ${themes ? "light-mode text-white" : "light-mode text-black"}`}
                ...
                <li
                  ...
                  className={`d-flex align-items-center justify-content-between p-3 rounded-3 mb-2 
                    ${room._id === activeRoomId 
                      ? themes 
                        ? "bg-danger text-white"  // Active + Dark
                        : "bg-danger text-black"  // Active + Light
                      : themes 
                        ? "bg-dark text-white"    // Inactive + Dark
                        : "bg-light text-dark"    // Inactive + Light
                    }`}
