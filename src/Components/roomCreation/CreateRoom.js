...
const CreateRoom = ({ themes }) => {
    ...
    return (
        <Container   style={{ minHeight: '100vh' }}className={themes ? 'dark-mode text-light' : 'light-mode text-dark'}>
            <Row className="justify-content-center " >
                <Col xs={12} md={10} lg={8}>
                    <Card style={{ marginTop: '140px' }} className={themes ? 'bg-dark text-light' : 'bg-light text-dark'}
                    >
                        <Card.Body>
  ...
  <div className={`p-2 rounded ${themes ? 'dark-calendar' : 'light-calendar'} d-flex justify-content-center`}>
    <Calendar
      className={`calendar-component ${themes ? 'dark-calendar' : 'light-calendar'}`}
...
<Form.Group className="mb-3">
  ...
  <div className={`p-2 rounded ${themes ? 'dark-calendar' : 'light-calendar'} d-flex justify-content-center`}>
    ...
    />
                                ...
                                <Button variant={themes  ? 'dark' : 'light'} onClick={handleCreateRoom}>
